...
export const adjustBalanceSchema = z.object({
  newBalance: z.number({ required_error: 'New balance is required' }),
  reason: z.string({ required_error: 'Reason is required for balance adjustments' }).min(5, 'Reason must be at least 5 characters long'),
});
